...
func TestVersionedSignedBuilderBidJSON(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			var res spec.VersionedSignedBuilderBid
