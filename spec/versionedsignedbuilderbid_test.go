...
func TestVersionedSignedBuilderBidMessageHashTreeRoot(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			res: phase0.Root{
				0xfb, 0x6b, 0x95, 0x14, 0xad, 0xbc, 0x98, 0xe3, 0xe5, 0x60, 0x30, 0xb1, 0x0e, 0x75, 0x5f, 0xc1,
				0x3b, 0xdb, 0x63, 0xaf, 0x15, 0xe6, 0xc9, 0x6e, 0x9b, 0xec, 0x0a, 0xc5, 0xef, 0x02, 0xf7, 0x78,
			},
		},
	}
			...
			bid: &spec.VersionedSignedBuilderBid{
				...
				Deneb: &deneb.SignedBuilderBid{
					Message: &deneb.BuilderBid{
						...
						BlobKZGCommitments: make([]consensusdeneb.KZGCommitment, 0),
						Value:              uint256.NewInt(12345),
					},
					Signature: phase0.BLSSignature{
						0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
